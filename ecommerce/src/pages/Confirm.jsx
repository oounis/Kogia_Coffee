...
export default function Confirm(){
  ...
  return (<div className="bg-ambient min-h-screen grid place-items-center p-6"><div className="card p-8 max-w-[560px] w-full text-center pop">
    <div className="w-16 h-16 rounded-full grid place-items-center text-white mx-auto" style={{background:'#E8962B'}}><CheckCircle2 size={32}/></div>
    ...
    <div className="rounded-2xl p-4 mt-5 text-left" style={{background:'#F6EAE0'}}>
      <div className="flex items-center gap-2 font-semibold" style={{color:'#E8962B'}}><Wallet size={16}/> Vous paierez {o.total} {CUR} en espèces à la livraison</div>
